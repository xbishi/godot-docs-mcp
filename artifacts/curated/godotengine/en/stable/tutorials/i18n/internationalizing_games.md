...
In code, the Object.tr() function can be used. This will just look up the text
...
If you are unsure about the language code to use, refer to the list of locale
codes.
